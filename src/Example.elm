module Example exposing (cookie, data, shouldShow, url)
...
decode : String -> Result JD.Error Data
decode json_ =
    JD.decodeString dataDecoder json_


shouldShow : Model -> Bool
shouldShow model =
    model.data == NotAsked && model.url == "" && model.cookie == ""
